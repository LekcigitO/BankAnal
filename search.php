...
$name = trim($_REQUEST['name']); // Получает содержимое поля "Автор" и убирает возможные пробелы в начале строки
...
$insert_sql = "INSERT INTO wp_9283a (author, title, text)" . // Указывает в какую таблицу и в какие поля ...
